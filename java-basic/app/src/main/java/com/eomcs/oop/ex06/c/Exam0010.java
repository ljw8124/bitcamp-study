...
class Score2 extends Score {
  ...
  //    원래의 메서드 보다 접근 범위가 줄어들면 안된다. 원래보다 작아지지만 않으면 됨

  @Override
  // - 컴파일러에게 상속 받은 메서드를 재정의 한다는 것을 알려준다. 생략은 가능하나 보통 씀!
  // - 만약 개발자가 메서드 이름을 다르게 사용하거나 파라미터를 잘못 선언하면
  // - 컴파일러가 즉시 알려준다.
  public void compute() { // 범위가 더 증가함
...
public class Exam0010 {
  public static void main(String[] args) {
    ...
    Score2 score = new Score2(); // 새로 재정의한  Score에 접근
    ...
    score.compute(); // 상속받은 compute가 아닌 재정의한 compute로 접근

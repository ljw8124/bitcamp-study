...
public class Exam0411 {
  public static void main(String[] args) {
    ...
    //s = -32769; // 컴파일 오류! -> 값을 벗어남
    //s = 32768; // 컴파일 오류! -> 값을 벗어남
    ...
    // 해결책?
    // - 4 byte 크기를 벗어나는 정수를 표기할 때는 반드시 숫자 뒤에 L 또는 l을 붙여야 한다. 여기서 l은 long을 의미함
    //i = -2147483649L; // 컴파일 오류가 발생하는 이유? i의 메모리의 크기가 4바이트라서 값을 저장할 수 없다.= 담을 수가 없다.
    //i = 2147483648L;  // 컴파일 오류!

    // 8바이트 크기의 정수 값을 담을 메모리 준비 
    long l;
    
    // 8바이트 메모리에 담을 수 있는 최소/최대 정수값 -> 초과하려면 double을 주어야 출력가능

...
public class Exam0424 {
  public static void main(String[] args) {
    ...
    // 4바이트 크기를 넘어가는 부동소수점 리터럴은 이미 짤린 값이기 때문에 제대로 저장될 수 없다. -> d > f
    ...
    // 컴파일 오류 대신 단지 값이 짤린다. -> 정수의 경우에는 오류, 부동소수점의 경우에는 값이 반올림되서 정확히 산출되지 않는다
    ...
    // 계산 방식에 의해 소수점 이하의 수가 근사 값으로 바뀐다. -> 오히려 채워줌 자리가 남기때문에

...
// - 값을 저장할 메모리의 타입(종류)와 크기를 결정하고 그 메모리에 이름을 부여한다.
...
// ## 변수의 이름
// - 보통 소문자로 시작한다.
// - 대소문자를 구분한다. 대문자로 시작하는 문법이 많기 때문에
// - 여러 단어로 구성된 경우 두 번째 단어의 시작 알파벳은 대문자로 한ㅋ다.
// - 예) firstName, createdDate, userId
// - 상수인 경우 보통 모두 대문자로 이름을 짓는다. 단어와 단어 사이는 _를 사용한다. -> 한번 정의하면 다시는 변하지 않음

...
//## 정수를 2진수로 표현하는 방법
//1) 부호-크기/절대값(Sign-Magnitude) ->부동소수점의 가수부를 저장할 때 사용한다
...
//  - 이해하기 쉽다!
//
//2) 1의 보수(Ones' Complement) -> 잘 사용하지 않음 (과거에 사용됨)
//- 모든 비트를 반대 값으로 바꾼다.
//  예) +24 => 0001 1000
//  예) -24 => 1110 0111
//- 수의 범위(8비트 기준): -127 ~ +127
...
//       0010(2) <--- 옳은 값!
//
//3) 2의 보수(Two's complement) -> 대부분 컴퓨터에서 정수를 저장하는 방식 (일반적으로 표현)
//- 자바에서 음수를 저장하는 방법이다.
...
//
//4) K-초과(Excess-K) -> 부동소수점의 지수부를 저장할 때 사용

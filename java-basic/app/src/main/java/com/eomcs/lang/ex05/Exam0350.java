...
public class Exam0350 {
  public static void main(String[] args) {
    ...
    // 정수 값에 대해서는 &&와 ||, !을 사용할 수 없다. -> 이 셋은 논리 연산자에만 사용 가능함
    ...
    System.out.println(a & b); // 그리고
    // a = 0000 0000 0000 0000 0000 0000 0110 1100
    // b = 0000 0000 0000 0000 0000 0000 0101 0101 => 둘 다 1이어야 밑에 1으로 출력
    // --------------------------------------------
    //     0000 0000 0000 0000 0000 0000 0100 0100 = 68

    System.out.println(a | b); // 또는
    // a = 0000 0000 0000 0000 0000 0000 0110 1100
    // b = 0000 0000 0000 0000 0000 0000 0101 0101 => 둘 중 하나만 1 이여도 밑에 1으로 출력
    // --------------------------------------------
    //     0000 0000 0000 0000 0000 0000 0111 1101 = 125

    System.out.println(a ^ b);
    // a = 0000 0000 0000 0000 0000 0000 0110 1100
    // b = 0000 0000 0000 0000 0000 0000 0101 0101 => 하나만 1일 때만 밑에 1으로 출력
    // --------------------------------------------
    //     0000 0000 0000 0000 0000 0000 0011 1001 = 57

    // 비트 연산에서 not은 ! 연산자가 아니라 ~ 연산자 이다.
    System.out.println(~a);
    // a = 0000 0000 0000 0000 0000 0000 0110 1100 -> 반대로 출력
    // --------------------------------------------
...
// 보통 천연색을 표현하기 위해 RGB 각 색상을 8비트로 표현한다.(256까지)
...
// => 특정 색상만 제거하기
// => 방법:
//    ^ 연산자를 사용하여 특정 색상만 제거할 수 있다. -> 두 개의 값 중 하나만 1일 때 출력하는 방법
// => 다음과 같이 비트 데이터가 있다.

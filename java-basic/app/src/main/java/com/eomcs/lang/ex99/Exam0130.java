...
public class Exam0130 {
  public static void main(String[] args) {
    ...
    java.util.Date today = new java.util.Date(); // today 는 래퍼런스, java.util.Date는 클래스
    // => Date 설계도에 따라 현재 일시정보를 담을 변수를 생성한다 -> 이 변수가 인스턴스(객체)
    // + 래퍼런스는 인스턴스의 주소를 저장하는 변수 == 객체를 가리키는 변수
    ...
    // d : 날짜 및 시각 데이터에서 일을 추출하여 무조건 2자리 숫자로 표현한다. ex) 01, 22
